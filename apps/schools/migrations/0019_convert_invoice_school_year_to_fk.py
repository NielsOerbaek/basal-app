...
def add_fk_column(apps, schema_editor):
    ...
    if column_exists(schema_editor, "schools_invoice", "school_year_id"):
...
def remove_fk_column(apps, schema_editor):
    """Remove FK column."""
    if not column_exists(schema_editor, "schools_invoice", "school_year_id"):
        return
    with schema_editor.connection.cursor() as cursor:
...
def migrate_m2m_to_fk(apps, schema_editor):
    ...
    if not table_exists(schema_editor, "schools_invoice_school_years"):
