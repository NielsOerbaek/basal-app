...
class EmailTemplate(models.Model):
    ...
    subject = models.CharField(
        max_length=255, verbose_name="Emne", help_text="Kan indeholde variabler som {{ course_title }}"
    )
    body_html = models.TextField(
        verbose_name="Indhold (HTML)", help_text="HTML-indhold. Kan indeholde variabler som {{ participant_name }}"
    )
...
class EmailLog(models.Model):
    ...
    email_type = models.CharField(max_length=30, choices=EmailType.choices, verbose_name="E-mail type")
